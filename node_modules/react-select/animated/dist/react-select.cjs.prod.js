...
var _objectWithoutProperties__default = _interopDefault(_objectWithoutProperties), memoizeOne__default = _interopDefault(memoizeOne), React__default = _interopDefault(React), _extends__default = _interopDefault(_extends), _classCallCheck__default = _interopDefault(_classCallCheck), _createClass__default = _interopDefault(_createClass), _inherits__default = _interopDefault(_inherits), _slicedToArray__default = _interopDefault(_slicedToArray), _excluded$4 = [ "in", "onExited", "appear", "enter", "exit" ], AnimatedInput = function(WrappedComponent) {
  ...
  return function(props) {
    return props.isMulti ? React__default.default.createElement(IsMultiValueContainer, _extends__default.default({
      component: WrappedComponent
    }, props)) : React__default.default.createElement(reactTransitionGroup.TransitionGroup, _extends__default.default({
      component: WrappedComponent
    }, props));
  };
  ...
  return index$1._objectSpread2(index$1._objectSpread2({}, props), {}, {
    ...
    children: React__default.default.Children.toArray(children).map((function(child) {
      if (isMulti && React__default.default.isValidElement(child)) {
        if (child.type === components.MultiValue) return React__default.default.cloneElement(child, {
          onExited: onExited
        });
