...
var index$1 = require('../../dist/index-b950ee42.cjs.dev.js');
...
var AnimatedValueContainer = function AnimatedValueContainer(WrappedComponent) {
  return function (props) {
    return props.isMulti ? /*#__PURE__*/React__default['default'].createElement(IsMultiValueContainer, _extends__default['default']({
      component: WrappedComponent
    }, props)) : /*#__PURE__*/React__default['default'].createElement(reactTransitionGroup.TransitionGroup, _extends__default['default']({
      component: WrappedComponent
    }, props));
  };
};
...
var useIsMultiValueContainer = function useIsMultiValueContainer(_ref2) {
  ...
  var childMapper = function childMapper(child) {
    if (isMulti && /*#__PURE__*/React__default['default'].isValidElement(child)) {
  ...
  var newProps = index$1._objectSpread2(index$1._objectSpread2({}, props), {}, {
    ...
    children: React__default['default'].Children.toArray(children).map(childMapper)
  });
