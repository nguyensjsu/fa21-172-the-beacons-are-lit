...
var LiveRegion = function LiveRegion(props) {
  ...
  var ScreenReaderText = react.jsx(React__default['default'].Fragment, null, react.jsx("span", {
    id: "aria-selection"
  }, ariaSelected), react.jsx("span", {
    id: "aria-context"
  }, ariaContext));
  var isInitialFocus = (ariaSelection === null || ariaSelection === void 0 ? void 0 : ariaSelection.action) === 'initial-input-focus';
  return react.jsx(React__default['default'].Fragment, null, react.jsx(A11yText, {
    id: id
...
function mergeStyles(source) {
  ...
  var styles = index._objectSpread2({}, source); // massage in target styles
...
function buildFocusableOptionsFromCategorizedOptions(categorizedOptions) {
  return categorizedOptions.reduce(function (optionsAccumulator, categorizedOption) {
    if (categorizedOption.type === 'group') {
      optionsAccumulator.push.apply(optionsAccumulator, _toConsumableArray__default['default'](categorizedOption.options.map(function (option) {
        return option.data;
      })));
    } else {
...
var Select = /*#__PURE__*/function (_Component) {
  ...
  function Select(_props) {
    ...
    _this.selectOption = function (newValue) {
      ...
      if (deselected) {
        ...
        if (isMulti) {
          _this.setValue(index.multiValueAsValue([].concat(_toConsumableArray__default['default'](selectValue), [newValue])), 'select-option', newValue);
        } else {
  ...
  _createClass__default['default'](Select, [{
    ...
    function getTheme() {
      ...
      return index._objectSpread2(index._objectSpread2({}, defaultTheme), this.props.theme);
    }
  }, {
    key: "getCommonProps",
    ...
    function renderInput() {
      ...
      var ariaAttributes = index._objectSpread2(index._objectSpread2({
      ...
      return /*#__PURE__*/React__default['default'].createElement(Input, _extends__default['default']({}, commonProps, {
        autoCapitalize: "none",
        autoComplete: "off",
        autoCorrect: "off",
        id: id,
    ...
    value: function renderPlaceholderOrValue() {
      ...
      if (!this.hasValue() || !controlShouldRenderValue) {
        return inputValue ? null : /*#__PURE__*/React__default['default'].createElement(Placeholder, _extends__default['default']({}, commonProps, {
          key: "placeholder",
          isDisabled: isDisabled,
          isFocused: isFocused,
          innerProps: {
      ...
      if (isMulti) {
        return selectValue.map(function (opt, index) {
          ...
          return /*#__PURE__*/React__default['default'].createElement(MultiValue, _extends__default['default']({}, commonProps, {
            components: {
      ...
      return /*#__PURE__*/React__default['default'].createElement(SingleValue, _extends__default['default']({}, commonProps, {
        data: singleValue,
        isDisabled: isDisabled
    ...
    value: function renderClearIndicator() {
      ...
      return /*#__PURE__*/React__default['default'].createElement(ClearIndicator, _extends__default['default']({}, commonProps, {
    ...
    value: function renderLoadingIndicator() {
      ...
      return /*#__PURE__*/React__default['default'].createElement(LoadingIndicator, _extends__default['default']({}, commonProps, {
        innerProps: innerProps,
        isDisabled: isDisabled,
        isFocused: isFocused
      }));
    ...
    value: function renderIndicatorSeparator() {
      ...
      var isFocused = this.state.isFocused;
      return /*#__PURE__*/React__default['default'].createElement(IndicatorSeparator, _extends__default['default']({}, commonProps, {
        isDisabled: isDisabled,
        isFocused: isFocused
      }));
    }
    ...
    value: function renderDropdownIndicator() {
      ...
      return /*#__PURE__*/React__default['default'].createElement(DropdownIndicator, _extends__default['default']({}, commonProps, {
        innerProps: innerProps,
        isDisabled: isDisabled,
        isFocused: isFocused
      }));
    ...
    value: function renderMenu() {
      ...
      var render = function render(props, id) {
        ...
        return /*#__PURE__*/React__default['default'].createElement(Option, _extends__default['default']({}, commonProps, {
          innerProps: innerProps,
          data: data,
          isDisabled: isDisabled,
          isSelected: isSelected,
      ...
      if (this.hasOptions()) {
        menuUI = this.getCategorizedOptions().map(function (item) {
          if (item.type === 'group') {
            ...
            return /*#__PURE__*/React__default['default'].createElement(Group, _extends__default['default']({}, commonProps, {
              key: groupId,
              data: _data,
              options: options,
      ...
      var menuElement = /*#__PURE__*/React__default['default'].createElement(index.MenuPlacer, _extends__default['default']({}, commonProps, menuPlacementProps), function (_ref4) {
        var ref = _ref4.ref,
            _ref4$placerProps = _ref4.placerProps,
            placement = _ref4$placerProps.placement,
            maxHeight = _ref4$placerProps.maxHeight;
        return /*#__PURE__*/React__default['default'].createElement(Menu, _extends__default['default']({}, commonProps, menuPlacementProps, {
          innerRef: ref,
          innerProps: {
          ...
          return /*#__PURE__*/React__default['default'].createElement(MenuList, _extends__default['default']({}, commonProps, {
      ...
      return menuPortalTarget || menuPosition === 'fixed' ? /*#__PURE__*/React__default['default'].createElement(MenuPortal, _extends__default['default']({}, commonProps, {
    ...
    value: function renderLiveRegion() {
      ...
      return /*#__PURE__*/React__default['default'].createElement(LiveRegion, _extends__default['default']({}, commonProps, {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default['default'].createElement(SelectContainer, _extends__default['default']({}, commonProps, {
        className: className,
        innerProps: {
          id: id,
        ...
        isDisabled: isDisabled,
        isFocused: isFocused
      }), this.renderLiveRegion(), /*#__PURE__*/React__default['default'].createElement(Control, _extends__default['default']({}, commonProps, {
      ...
      }), /*#__PURE__*/React__default['default'].createElement(ValueContainer, _extends__default['default']({}, commonProps, {
        isDisabled: isDisabled
      }), this.renderPlaceholderOrValue(), this.renderInput()), /*#__PURE__*/React__default['default'].createElement(IndicatorsContainer, _extends__default['default']({}, commonProps, {
        isDisabled: isDisabled
    ...
    value: function getDerivedStateFromProps(props, state) {
      ...
      return index._objectSpread2(index._objectSpread2(index._objectSpread2({}, newMenuOptionsState), newInputIsHiddenState), {}, {
        prevProps: props,
